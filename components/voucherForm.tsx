    ...
    <Card>
      ...
      <CardContent>
        <div className="grid gap-4">
          ...
          />
          <Button onClick={()=>handleFetchSalesEntries()}>Fetch Sales Entries</Button>
          {vouchers.length > 0 && (
            //@ts-ignore
            <VoucherList vouchers={vouchers} onSelect={setSelectedEntries} selectedEntries={selectedEntries} />
          )}
